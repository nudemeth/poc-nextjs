...
describe('Header component', () => {
    it('Should show child component', () => {
        const wrapper = shallow(<Header classes={classes} theme={theme} handleDrawerToggle={()=>{}}><h1>This is child component</h1></Header>)
    ...
    it('Should show menu button', () => {
        const wrapper = shallow(<Header classes={classes} theme={theme} handleDrawerToggle={()=>{}}><h1></h1></Header>)
