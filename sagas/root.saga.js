...
import * as itemSaga from './item.saga';
...
function * rootWatcher() {
    yield effects.all([
        ...
        effects.takeEvery(actionTypes.LOAD_ITEMS, itemSaga.loadItemsWorker),
        effects.takeEvery(actionTypes.LOAD_ITEM, itemSaga.loadItemWorker),
